  ...
  <div class="FBDateGroup">
    ...
    <div class="GroupContent">
      <div style="width: calc(50% - 12px); position: relative">
        <input type="text" name="dateS" class="startUpDate" placeholder="請選擇日期(起)" style="width: 100%" />
        <img class="icon-calendar" src="../images/icon-calendar.svg" />
        <p>{{ fieldVal }}</p>
      </div>
      <div style="width: 24px">-</div>
      <div style="width: calc(50% - 12px); position: relative">
        <input type="text" name="dateE" class="startUpDate" placeholder="請選擇日期(迄)" style="width: 100%" />
        <img class="icon-calendar" src="../images/icon-calendar.svg" />
        <p>{{ fieldVal }}</p>
      </div>
    </div>
